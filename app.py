...
@st.cache_resource
def load_model():
    model = pickle.load(open(r'C:\Users\31syl\Desktop\Smart Pred\regression_model.pkl', 'rb'))
    return model

model = load_model()

transformer = pickle.load(open(r'C:\Users\31syl\Desktop\Smart Pred\transformer.pkl','rb'))


df = pd.read_csv(r'C:\Users\31syl\Desktop\Smart Pred\analysis_df.csv')
